...
- role: control-plane
  extraMounts:
    - hostPath: /tmp/litecoin
      containerPath: /home/litecoin/.litecoin
...
# Apply litecoin Namespace, StorageClass, Persistent Volume, Service, Stetefulset resources
